<script>
  ...
  const activeStyle = 'block py-2 px-3 text-lg hover:underline text-white bg-blue-700 rounded lg:bg-transparent lg:text-blue-700 lg:p-0 dark:text-white lg:dark:text-blue-500'
</script>
