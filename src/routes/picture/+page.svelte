...
<div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
  ...
  <p class="m-4 text-xl text-purple-500 hover:underline cursor-pointer"><button  onclick={() => openTab(randomElement.label, 'ordbokene')}>Open Ordbøkene: {dictWord}</button>
  </p>
  </div>
  <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
  <p class="m-4 text-xl text-purple-500 hover:underline cursor-pointer"><button  onclick={() => openTab(randomElement.label, 'google')}>Open Google translation: {dictWord}</button>
  </p>
  </div>
</div>
{:else}
