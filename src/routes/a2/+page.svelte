<script>
	...
	function handleClick() {
		...
		{#if randomElement}
		<p class="w-full md:w-2/3 h-64 flex justify-center items-center text-4xl mx-auto text-white bg-custom-red dark:bg-custom-red border border-gray-200 rounded-lg shadow">
			{randomElement}
		</p>
