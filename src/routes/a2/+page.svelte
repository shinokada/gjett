<script>
	...
	function handleClick() {
		...
		<h1 class="mb-4 text-3xl text-left font-extrabold tracking-tight leading-none text-gray-900 md:text-4xl sm:text-center lg:text-5xl dark:text-white">Nivå A2</h1>
		...
		{#if randomElement}
		<p class="w-full md:w-2/3 h-64 flex justify-center items-center text-4xl mx-auto text-white bg-custom-red dark:bg-custom-red border border-gray-200 rounded-lg shadow dark:border-gray-700">
			{randomElement}
		</p>
